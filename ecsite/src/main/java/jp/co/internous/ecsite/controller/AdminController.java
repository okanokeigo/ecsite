...
public class AdminController {
	...
	public String welcome(LoginForm form, Model m) {
		...
		System.out.println("入力内容⇒" + form.getUserName()+"："+ form.getPassword());
	     System.out.println("DB内容⇒" + users.get(0).getUserName()+"："+ users.get(0).getPassword()+"："+ users.get(0).getIsAdmin());
